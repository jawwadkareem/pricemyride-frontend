...
const PriceMyRide = () => {
  ...
  return (
    ...
    >
     ...
     {/* Calculator Box */}
<div className="absolute bottom-3 right-3 group w-[60px] sm:w-[50px] md:w-[110px] h-[80px] sm:h-[70px] md:h-[130px] bg-[#277ec5] hover:bg-blue-300 rounded-2xl flex items-center justify-center cursor-pointer transition-all duration-300">
