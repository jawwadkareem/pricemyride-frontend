...
const PriceMyRide = () => {
  ...
  return (
    ...
    >
     ...
     {/* Calculator Box */}
<div className="absolute bottom-4 right-5 group w-[60px] sm:w-[60px] md:w-[110px] h-[80px] sm:h-[80px] md:h-[130px] bg-[#277ec5] hover:bg-blue-300 rounded-2xl flex items-center justify-center cursor-pointer transition-all duration-300">
  ...
  <img
    ...
    alt="Calculator Icon"
    onClick={() => setIsModalVisible(true)}
    className="w-[40px] sm:w-[30px] md:w-[80px] h-[60px] sm:h-[50px] md:h-[110px] transition-all duration-300"
  />
</div>
